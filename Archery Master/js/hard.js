...
"use strict";
    ...
    function updArr(arrNum){
        var arr = "<span style='color:orange; font-size:40px;'>&uarr;</span>";
    ...
    function drawBoard() {
        ...
        ctx.moveTo(board.x,board.y-20);
        ctx.quadraticCurveTo(board.x-10,board.y,board.x,board.y+20);
    ...
    Arrow.prototype.drawArrow = function() {
        if(this.vis) {
                    ...
                    if(this.x < w-155){
                        ...
                        if(!(this.fy <= board.y-board.height/2 || this.fy >= board.y+board.height/2) || this.x > w){
                            if(this.x > w-110){
                                ...
                                //boardmove false after score hits +4
                                else if(score === 4){
                                    arc.dy = 4;
                                    autoMove = true;
                                }
            ...
            try{
                                ...
                                document.body.removeEventListener("32",shoot);
