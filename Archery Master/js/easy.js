...
"use strict";
    ...
    function updArr(arrNum){
        var arr = "<span style='color:black; font-size:40px;'>&uarr;</span>";
    ...
    function drawBoard() {
        ...
        //board color
        ctx.fillStyle = "red"; //center color
        ctx.fill();
        ctx.closePath();
        ctx.fillStyle = "black";
                    ...
                    if(this.x < w-155){
                        ...
                        if(!(this.fy <= board.y-board.height/2 || this.fy >= board.y+board.height/2) || this.x > w){
                            if(this.x > w-110){
                                ...
                                //bow move up and down speed if hit=4 
                                if(score === 3){
                                    arc.dy = 2;
                                    arc.dx =4 
                                ...
                                //board move false after score hits +8
                                else if(score === 8){
                                    autoMove = false;
                                }
